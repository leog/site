...
description: >-
  It may come as a surprise, but not every single professional move has
  calculated steps. At least for me.
keywords:
  - open-source
  - career
date: '2025-10-26'
...
Of course I took it, and worked there for almost a year and a half. The way they handled feedback of your work wasn't good, and the way they handled layoffs was also not good. People came to work with the core team and some weeks later they were gone. They were proud to use a method called Lean Hire, where people could be put to the test while also contributing to the product and if things fit well, they were hired. But the people that got to the core team and were gone very quickly was not following that method. They were part of the core and were presented as such. Anyway, I was in a weird spot, knew how they handle weird spots and even though I was assured I was working well and pushing through major stuff that came my way, the situation was untenable. A short period passed and I got to the engineering manager / architect position again in another software factory company. Luckily my current position already comes with coding needs.

Would I do it again? Absolutely. The stumble taught me that the side project you pick for the right reasons can become the job, and that even a job that ends badly can leave you with a better resume, a bigger network, and a clearer idea of what you want next.
